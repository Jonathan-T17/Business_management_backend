class Capabilities:
    ...
    MANAGE_COMPANY_SETUP = "MANAGE_COMPANY_SETUP"
    ...
    USE_FORMS = "USE_FORMS"  # Compatibility alias accepted for submission authority.
    SUBMIT_FORMS = "SUBMIT_FORMS"
    VIEW_FORM_SUBMISSIONS = "VIEW_FORM_SUBMISSIONS"
    CONFIGURE_SENSITIVE_FORMS = "CONFIGURE_SENSITIVE_FORMS"
    ...
    VIEW_HR_CONFIDENTIAL = "VIEW_HR_CONFIDENTIAL"
    VIEW_PERSONAL_DATA = "VIEW_PERSONAL_DATA"
    VIEW_FINANCIAL_DATA = "VIEW_FINANCIAL_DATA"
    VIEW_MANAGEMENT_CONFIDENTIAL = "VIEW_MANAGEMENT_CONFIDENTIAL"
    ...
    SENSITIVE = {
        CONFIGURE_SENSITIVE_FORMS, VIEW_HR_CONFIDENTIAL, VIEW_PERSONAL_DATA,
        VIEW_FINANCIAL_DATA, VIEW_MANAGEMENT_CONFIDENTIAL,
        VIEW_COMPENSATION,
        MANAGE_COMPENSATION,
